<div class="container-fluid">
    ...
    <div class="alert alert-success" role="alert">
        <i class=" fas fa-clipboard-list"></i> Jurusan
    </div>

    <?php echo $this->session->flashdata('pesan') ?>

    <?php echo anchor('administrator/jurusan/input','<button
        class="btn btn-sm btn-primary mb-3"><i class="fas fa-plus fa-sm"></i> TAMBAH JURUSAN</button>') ?>
